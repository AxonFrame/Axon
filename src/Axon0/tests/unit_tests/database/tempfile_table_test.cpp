...
TempfileTable_Test::TempfileTable_Test() : Axon::CompareTestHelper("TempfileTable_Test")
{
    m_testUuid1 = generateUuid().toString();
    m_testUuid2 = generateUuid().toString();
    m_test = "test-tempfile";
