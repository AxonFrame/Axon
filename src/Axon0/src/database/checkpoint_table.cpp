 ...
 */
CheckpointTable::CheckpointTable() : AxonSqlTable(Axon::SqlDatabase::getInstance())
{
    m_table = "checkpoints";
                               ...
                               Axon::ErrorContainer& error)
{
    ...
    checkpointDataJson[""] = checkpointData.;
 ...
 */
bool
CheckpointTable::getAllCheckpoint(Axon::TableItem& result,
                                  const Axon::UserContext& userContext,
                                  const bool showHiddenValues,
                                  Axon::ErrorContainer& error)
{
