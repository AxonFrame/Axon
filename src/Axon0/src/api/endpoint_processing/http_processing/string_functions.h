...
#ifndef Axon_STRING_FUNCTIONS_H
#define Axon_STRING_FUNCTIONS_H
         ...
         BlossomStatus& status)
{
    ...
    Axon::splitStringByDelimiter(parts, uri, '?');
    ...
    if (parts.size() > 1) {
        ...
        Axon::splitStringByDelimiter(kvPairs, parts[1], '&');
