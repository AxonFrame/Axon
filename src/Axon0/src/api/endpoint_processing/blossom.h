...
#ifndef Axon_BLOSSOM_H
#define Axon_BLOSSOM_H
...
inline const Axon::UserContext
convertContext(const json& inputContext)
{
    Axon::UserContext context;
...
class Blossom
{
   ...
   protected:
    ...
    FieldDef& registerInputField(const std::string& , const FieldType fieldType);
    FieldDef& registerOutputField(const std::string& , const FieldType fieldType);
   ...
   private:
    ...
    void createError(const BlossomIO& blossomIO, Axon::ErrorContainer& error);
};

#endif  // Axon_BLOSSOM_H
