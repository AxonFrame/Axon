...
main(int argc, char* argv[])
{
    ...
    // init logger
    Axon::setErrorLogCallback(&handleErrorCallback);
    Axon::initConsoleLogger(enableDebug);
    Axon::initFileLogger(logPath, "Axon", enableDebug);
