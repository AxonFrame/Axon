...
#ifndef Axon_STATEMACHINE_INIT_H
#define Axon_STATEMACHINE_INIT_H
...
void initStatemachine(Axon::Statemachine& sm, Cluster* cluster, TaskHandle_State* taskState);

#endif  // Axon_STATEMACHINE_INIT_H
