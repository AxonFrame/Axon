 ...
 */
void
initStates(Axon::Statemachine& sm)
{
 ...
 */
void
initEvents(Axon::Statemachine& sm, Cluster* cluster, TaskHandle_State* taskState)
{
 ...
 */
void
initChildStates(Axon::Statemachine& sm)
{
 ...
 */
void
initInitialChildStates(Axon::Statemachine& sm)
{
 ...
 */
void
initTransitions(Axon::Statemachine& sm)
{
 ...
 */
void
initStatemachine(Axon::Statemachine& sm, Cluster* cluster, TaskHandle_State* taskState)
{
    initStates(sm);
