...
#ifndef Axon_ROUTING_FUNCTIONS_H
#define Axon_ROUTING_FUNCTIONS_H
 ...
 */
inline Axon::Position
getNeighborPos(const Axon::Position sourcePos, const uint8_t side)
{
    Axon::Position result;
...
#endif  // Axon_ROUTING_FUNCTIONS_H
