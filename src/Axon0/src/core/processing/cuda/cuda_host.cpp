...
CudaHost::initBuffer()
{
    ...
    // SynapseBlock* cpuSynapseBlocks = Axon::getItemData<SynapseBlock>(synapseBlocks);
...
CudaHost::moveHexagon(Hexagon* hexagon)
{
    ...
    SynapseBlock* cpuSynapseBlocks = Axon::getItemData<SynapseBlock>(originHost->synapseBlocks);
