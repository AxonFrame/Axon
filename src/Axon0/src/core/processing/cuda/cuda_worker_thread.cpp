 ...
 */
void
CudaWorkerThread::handleTrainForwardTask(Axon::WorkerTask task)
{
 ...
 */
void
CudaWorkerThread::handleTrainBackwardTask(Axon::WorkerTask task)
{
    Hexagon* hexagon = &task.cluster->hexagons[task.hexagonId];
 ...
 */
void
CudaWorkerThread::handleProcessTask(const Axon::WorkerTask task)
{
    Hexagon* hexagon = &task.cluster->hexagons[task.hexagonId];
...
void
CudaWorkerThread::handleReductionTask(const Axon::WorkerTask task)
{
}
