 ...
 */
uint64_t
processMessageUnixDomain(void* target, Axon::RingBuffer* recvBuffer, AbstractSocket*)
{
...
UnixDomain_Test::UnixDomain_Test() : Axon::MemoryLeakTestHelpter("UnixDomain_Test")
{
