...
Axon::Session_Test* Session_Test::m_instance = nullptr;
 ...
 */
void
errorCallback(Axon::Session*, const uint8_t, const std::string message)
{
 ...
 */
void
sessionCreateCallback(Axon::Session* session, const std::string sessionIdentifier)
{
...
void
sessionCloseCallback(Axon::Session*, const std::string)
{
 ...
 */
Session_Test::Session_Test() : Axon::CompareTestHelper("Session_Test")
{
