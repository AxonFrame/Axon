 ...
 * @param thread base- for server and client threads
 *
                                       ...
                                       const std::string& thread)
{
    ...
    server = new TemplateServer<UnixDomainServer>(
        std::move(udsServer), this, &processConnection_Callback, thread);
                                ...
                                const std::string& thread)
{
    ...
    server = new TemplateServer<TcpServer>(
        std::move(tcpServer), this, &processConnection_Callback, thread);
                                   ...
                                   const std::string& thread)
{
    ...
    server = new TemplateServer<TlsTcpServer>(
        std::move(tlsTcpServer), this, &processConnection_Callback, thread);
                                          ...
                                          ErrorContainer& error)
{
    ...
    unixDomainSocket = new TemplateSocket<UnixDomainSocket>(std::move(udsSocket), thread);
                                   ...
                                   ErrorContainer& error)
{
    ...
    tcpTemplateSocket = new TemplateSocket<TcpSocket>(std::move(tcpSocket), thread);
                                      ...
                                      ErrorContainer& error)
{
    ...
    tlsTcpTemplSocket = new TemplateSocket<TlsTcpSocket>(std::move(tlsTcpSocket), thread);
