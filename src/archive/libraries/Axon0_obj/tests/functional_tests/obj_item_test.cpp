...
ObjItem_Test::ObjItem_Test() : Axon::CompareTestHelper("ObjItem_Test")
{
    parse_test();
    converter_test();
}
...
ObjItem_Test::parse_test()
{
    ...
    bool ret = Axon::parseString(result, getTestString(), error);
    TEST_EQUAL(ret, true);
...
ObjItem_Test::converter_test()
{
    ...
    ret = Axon::convertToString(convertedString, result);
