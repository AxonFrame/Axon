 ...
 *
 * @param {target} base- of the modal, where the error-message belongs to
 */
...
{     
    ...
    listRequestConnection.onload = function(e) 
    {
        ...
        // search for the column, which has the title "" and get its position
