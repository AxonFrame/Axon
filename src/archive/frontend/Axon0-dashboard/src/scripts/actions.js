...
function openGenericModal(outputFunc, modal, clearFunction, closeModal=true) 
{
    clearFunction();

    let modal = document.getElementById(modal);
    let acceptButton = document.getElementById(modal + "_accept_button");
    let cancelButton = document.getElementById(modal + "_cancel_button");
