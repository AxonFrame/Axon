...
{
    protobuf.load("/Axon_messages/protobuffers/Axon_messages.proto3", function(err, root) 
    {
        if(err) {
            throw err;
        }
...
function createMnistDataSet_request(outputFunc, , inputFile, labelFile, token)
{
...
function createCsvDataSet_request(outputFunc, , inputFile, token)
{
