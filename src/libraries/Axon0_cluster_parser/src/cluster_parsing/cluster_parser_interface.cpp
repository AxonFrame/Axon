...
Axon::ClusterParserInterface* ClusterParserInterface::m_instance = nullptr;
                              ...
                              ErrorContainer& error)
{
    ...
    m_errorMessage = "";
    int parserResult = 0;
    Axon::ClusterParser parser(*this);
 ...
 */
void
ClusterParserInterface::error(const Axon::location& location, const std::string& message)
{
