...
#define YY_DECL Axon::IniParser::symbol_type inilex(Axon::IniParserInterface& driver)
YY_DECL;

namespace Axon
{

Axon::IniParserInterface* IniParserInterface::m_instance = nullptr;
