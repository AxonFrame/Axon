...
// The parsing context.
%param { Axon::PolicyParserInterface& driver }
...
Axon::PolicyEntry tempPolicyEntry;
...
void Axon::PolicyParser::error(const Axon::location& location,
