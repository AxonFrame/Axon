...
#define YY_DECL Axon::PolicyParser::symbol_type policylex(Axon::PolicyParserInterface& driver)
YY_DECL;

namespace Axon
{

Axon::PolicyParserInterface* PolicyParserInterface::m_instance = nullptr;

using Axon::splitStringByDelimiter;
 ...
 */
void
PolicyParserInterface::error(const Axon::location& location, const std::string& message)
{
