...
ConfigHandler_Test::ConfigHandler_Test() : Axon::CompareTestHelper("ConfigHandler_Test")
{
    initTestCase();
...
ConfigHandler_Test::initTestCase()
{
    ...
    Axon::writeFile(m_testFilePath, getTestString(), error, true);
}
...
ConfigHandler_Test::isRegistered_test()
{
    ...
    configHandler.registerString(group, "key1");
...
ConfigHandler_Test::getRegisteredType_test()
{
    ...
    configHandler.registerString(group, "key1");
    configHandler.registerInteger(group, "key2");

    TEST_EQUAL(configHandler.getRegisteredType("group", "key1"),
               ConfigHandler::ConfigDef::STRING_TYPE);
    TEST_EQUAL(configHandler.getRegisteredType("group", "key2"),
