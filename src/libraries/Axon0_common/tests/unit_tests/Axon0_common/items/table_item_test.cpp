...
TableItem_test::TableItem_test() : Axon::CompareTestHelper("TableItem_test")
{
 ...
 */
void
TableItem_test::reColume_Test()
{
    TableItem testItem;

    testItem.addColumn("asdf", "ASDF");

    TEST_EQUAL(testItem.reColume("asdf", "XYZ"), true);
    TEST_EQUAL(testItem.reColume("fail", "XYZ"), false);
