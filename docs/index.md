...
<p align="center">
  <img src="img/Axon-logo-with-text.png" width="500" height="594" />
</p>
...
Axon contains in its core a custom experimental artificial neural network, which can work on
...
Axon is to create something unique, which works more like the human brain. It wasn't targeted
...
-   **Reduction-Process**
    ...
    See
    [measurement-examples](https://docs.Axon.com/inner_workings/measurements/measurements/#reduction_1)
...
-   **Spiking neural network**
    ...
    See
    [short explanation](https://docs.Axon.com/inner_workings/core/core/#spiking-neural-network)
    and [measurement-examples](https://docs.Axon.com/inner_workings/measurements/measurements)
...
-   **No strict layer structure**
    ...
    See
    [short explanation](https://docs.Axon.com/inner_workings/core/core/#no-strict-layer-structure)
    and [measurement-examples](https://docs.Axon.com/inner_workings/measurements/measurements)
...
-   **3-dimensional networks**
    ...
    [cluster-templates](https://docs.Axon.com/frontend/cluster_templates/cluster_template/),
...
-   **Generated OpenAPI-Documentation**
    ...
    See [OpenAPI-docu](https://docs.Axon.com/frontend/rest_api_documentation/)
...
-   **Multi-user and multi-project**
    ...
    Each user can login by user and passphrase and gets an JWT-token to access the user- and
    project-specific resources.

    See [Authentication-docu](https://docs.Axon.com/inner_workings/user_and_projects/)
...
-   **Efficient resource-usage**
    ...
    3. Capability to regulate the cpu-frequencey and measure power-consumption. (disabled currently)
        ...
        See
        [Monitoring-docu](https://docs.Axon.com/inner_workings/monitoring/monitoring/#controlling-cpu-frequency)
...
-   **Network-input**
    ...
    2. Directly communicate with the neural network via websocket. In this case not a whole dataset
       ...
       blocking, until the network returns the output, which gives more control.
        ...
        See [Websocket-docu](https://docs.Axon.com/frontend/websockets/websocket_workflow/)

-   **Installation on Kubernetes**

    The backend can be basically deployed on kubernetes via Helm-chart.

    See [Installation-docu](https://docs.Axon.com/backend/installation/)
...
-   :octicons-codespaces-24:{ .lg .middle } **Development**
    ...
    ***
    ...
    [:octicons-arrow-right-24: Contributing guide](https://github.com/AxonFrame/Axon/blob/develop/CONTRIBUTING.md)
...
-   :octicons-package-24:{ .lg .middle } **Pre-build objects**
    ...
    ***
    ...
    [CI-pipeline](https://github.com/AxonFrame/Axon/actions/workflows/build_test.yml) for
    each merge on `develop`-branch and for each tag.

    [:octicons-arrow-right-24: Docker-images](https://hub.docker.com/repository/docker/kitsudaiki/Axon/tags)

    [:octicons-arrow-right-24: client, SDK and helm-chart](https://files.Axon.com/)
...
1. Dashboard
    ...
    PoC-dashboard: [Dashboard-docu](https://docs.Axon.com/frontend/dashboard/dashboard/)
...
[Apache 2 license](https://github.com/AxonFrame/Axon/blob/develop/LICENSE).
